...
* Adjust default resource requests and limits - PR[#741](https://github.com/khulnasoft/khulnasoft-helm/pull/741)
* Update enforcer chart version to `2022.4.13`

## 2022.4.22 ( Apr 10th, 2023 )
* Add ability to define extraVolumes - PR [#728](https://github.com/khulnasoft/khulnasoft-helm/pull/728)
* Adjust default resource requests and limits - PR[#729](https://github.com/khulnasoft/khulnasoft-helm/pull/729)
* Add priorityClass - PR[#734](https://github.com/khulnasoft/khulnasoft-helm/pull/734)
* Fix starboard namespace default assignment - Issue[#735](https://github.com/khulnasoft/khulnasoft-helm/issues/735)
...
* Fix [695](https://github.com/khulnasoft/khulnasoft-helm/issues/695)
...
* Change env of NODE_LABELS_TO_SKIP_KUBE_BENCH to KHULNASOFT_NODE_LABELS_TO_SKIP_KB [#644](https://github.com/khulnasoft/khulnasoft-helm/pull/644)
* Fix typo in cds.yaml.tpl [#653](https://github.com/khulnasoft/khulnasoft-helm/pull/653)
## 2022.4.7 ( Aug 12th, 2022 )
* Add support to exclude Nodes From Kube-Bench based on labels [#635](https://github.com/khulnasoft/khulnasoft-helm/issues/635)
## 2022.4.6 ( Jul 28th, 2022 )
* Add podLables and resources to starboard deployment issue [#632](https://github.com/khulnasoft/khulnasoft-helm/issues/632)
...
* Fix annotations for tolerations issue [#599](https://github.com/khulnasoft/khulnasoft-helm/issues/599) by adding tolerations at spec
* Add PodDisruptionBudget to kube-enforcer deployment [#613](https://github.com/khulnasoft/khulnasoft-helm/pull/613/files)
## 2022.4.1 ( Jun 7th, 2022 )
* Update Enforcer chart version
* Move CRD's to separate folder [#609](https://github.com/khulnasoft/khulnasoft-helm/pull/609)
